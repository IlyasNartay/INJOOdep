            ...
            <div class="relative">
              <CustomModal v-if="successEdit">
                <div class="relative z-10 backdrop-blur-md bg-white/20 border border-white/30 p-6 rounded-2xl shadow-xl w-[90%] max-w-md text-center">
                  ...
                  <h3 class="text-xl font-semibold text-black mb-2">Вы успешно поменяли блюдо!</h3>
              ...
              <CustomModal v-if="fail">
                <div class="relative z-10 backdrop-blur-md bg-white/20 border border-white/30 p-6 rounded-2xl shadow-xl w-[90%] max-w-md text-center">
                  <img src="/fail-modal.svg" alt="Не Успешно" class="w-16 h-16 mx-auto mb-4" />
            ...
            <div class="p-3 sm:p-4">
              ...
              <div class="flex items-center justify-end gap-4 text-xs sm:text-sm">
                <div class="flex items-center space-x-2 sm:space-x-4">
                  ...
                  <div v-show="role === 'customer' || role === 'guest'" class="inline-block">
                    <div
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="relative p-4 bg-white rounded-lg w-[90vw] max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div class="mb-4">
            ...
            <ImageEditor
              :current-image-url="editingDish.images?.length ? image_url + editingDish.images[0].image_url : null"
              :aspect-ratio="4/3"
