      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2 p-8 max-[335px]:p-2">
            ...
            <div class="flex justify-between w-[80%] max-[480px]:w-full gap-4 pb-4 mb-6
            ...
            <div class="space-y-6">
              ...
              >
                ...
                <div class="flex items-center space-x-4 flex-1">
                  <div class="w-20 h-20 max-[480px]:w-[40px] max-[480px]:h-[40px]
            ...
            <div class="sticky top-8 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  @input="onKaspiInput"
                  @keydown="onKaspiKeydown"
                  placeholder="+7 (700) 000-00-00"
                  maxlength="18"
                  class="w-full rounded-lg border border-gray-300 px-4 py-2 mb-3
...
// Kaspi: отображаемое значение с маской и чистые цифры
const kaspiPhoneDisplay = ref("");
const kaspiPhoneRaw     = ref(""); // только цифры, 11 штук: 87XXXXXXXXX
...
function onKaspiInput(e) {
  // Оставляем только цифры из введённого текста
  let digits = e.target.value.replace(/\D/g, "");
  // Если начинается с 8 — заменяем на 7 (казахстанский формат)
  if (digits.startsWith("8")) digits = "7" + digits.slice(1);
  // Если не начинается с 7 — добавляем
  if (digits.length && !digits.startsWith("7")) digits = "7" + digits;
  kaspiPhoneRaw.value = digits;
  kaspiPhoneDisplay.value = formatKaspi(digits);
}

function onKaspiKeydown(e) {
...
const makeOrder = async () => {
  ...
  try {
    await axios.post(`${apiBase}orders/`, {
      ...
      kaspi_number: kaspiPhoneRaw.value,   // отправляем чистые цифры: 87XXXXXXXXX
